...
export default function ProjectsListItem({ project, className = "" }: Props) {
	...
	const content = (
		<>
			...
			>
				<figure className="aspect-video w-full overflow-hidden rounded-lg md:rounded-xl">
					{project.image ? (
						<img
			...
			<div className="border-ink-black-dimmed/25 flex flex-wrap items-baseline items-center justify-between gap-x-4 gap-y-1 border-b px-2 py-6 md:px-4 md:py-8">
				<h3
